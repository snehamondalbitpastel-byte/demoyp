...
/* ================================================================
 * HANDOVER PACKAGE — Career Talks Module  ⚠ TEMPORARY FILE
 * File:    src/app/career-talks/upload/page.tsx
 * Route:   /career-talks/upload            (Admin uploader)
 * Role:    Spreadsheet uploader — accepts .xlsx / .csv, parses via
 *          SheetJS (parseSheet.ts), shows a preview table, and
 *          commits to localStorage so the listing + details pages
 *          have real data to render BEFORE the backend API exists.
 *          Also: re-openable "view saved talks" toggle, inline save
 *          error surface for quota / private-mode failures.
 * COPY?:   ⚠ Copy NOW so teammates can seed data, then DELETE the
 *          whole `upload/` folder + parseSheet.ts + the xlsx dep +
 *          the Upload nav link once the real /api/career-talks
 *          endpoint is wired into useCareerTalks.ts.
 * See README.md §5 (Swapping to the real API).
 * ================================================================ */
