 ...
 *          loads Font Awesome + Line Awesome (CDN), and ships the
 *          pre-hydration script that stamps `data-theme="light"` on
 *          <html> before first paint on /career-talks routes.
 * COPY?:   ❌ DO NOT copy into the target project — the real YP
 *          project has its own layout. The only thing worth keeping
 *          from here is the pre-hydration <script> in <head> (lines
 *          marked below) if the target's layout doesn't already do
 *          the same anti-flash trick.
...
export const metadata: Metadata = {
  title: "Career Talks Demo",
  description: "Standalone runnable demo of the Career Talks UI",
};
    ...
    >
      <head>
        {/* Line Awesome — needed for `las la-*` icon classes the live YP
            site uses (e.g. `la-search-plus` on the showcase image hover
            affordance). Served from jsdelivr (mirrors the npm package
        ...
        {/* Pre-hydration theme bootstrap — synchronously sets
            <html data-theme="light"> before first paint on /career-talks
